...
let make_prologue consts_tbl fvars_tbl =
  (* The table defines a mapping from the names of primitive procedures in scheme to their labels in 
     ...
     (* primitive_names_to_labels is a table where the right column is the scheme name of
     a  primitive function and the left column is the lable of the function in the
     assembly file *)
  ...
  [
    ...
    "apply", "apply"; "car", "car"; "cdr", "cdr"; "cons", "make_cons"; "set-car!", "set_car"; "set-cdr!", "set_cdr";
  ] in
  let make_primitive_closure (prim, label) =
    ...
    "MAKE_CLOSURE(rax, SOB_NIL_ADDRESS, " ^ label  ^ ")\n" ^
      "mov FVAR(" ^  (string_of_int (List.assoc prim fvars_tbl)) ^ "), rax" in
